...
$update = "UPDATE customer SET email = '$email', password = '$password', phone = '$phone' WHERE cust_id = '".$_SESSION['user_id']."' ";
$query = mysqli_query($conn,$update);
if($query){
    echo '<br>UPDATE data is successful';
} else {
	echo '<br>UPDATE data is not valid';
